...
cwd=`pwd`
os_image_path=${cwd}/os-image/${OS_NAME}-${OS_VERSION}.tgz
...
sudo --preserve-env --set-home --user ubuntu -- /bin/bash --login -i <<SUDO
  ...
  bundle exec rake stemcell:build_with_local_os_image[$IAAS,$HYPERVISOR,$OS_NAME,$OS_VERSION,$os_image_path,$build_number]
SUDO
